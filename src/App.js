      ...
      <div className="aplicacao">
        ...
        <div class="w3-panel">
          <div class="w3-row">
            ...
            <h4 className="w3-center"><strong>ABERTURA </strong></h4> 
            <div class="w3-panel w3-yellow w3-topbar w3-bottombar w3-border-amber">
              <p>acolhida, canto, intençoes, oracao do espirito santo e sinal da cruz; </p>
            </div>  
            </div>
          </div>  
        <hr/>
          <div class="w3-row">
            <div class="w3-col s12 w3-container">
              <h4 className="w3-center"><strong>Oração pela igreja e pelos sarcedotes</strong></h4>
        ...
        <hr/>
          <div class="w3-row">
            <div class="w3-col s12 w3-container">
              ...
              <ul className="w3-ul w3-hoverable">
                ...
                <li> Pelas lágrimas de sua mãe, que veio ao seu encontro, <strong>tende misericórdia de nós e do mundo inteiro.</strong></li>
                <li> Pelo seu cansaço atroz, devido ao qual obrigaram um homem a ajudá-lo, <strong>tende misericórdia de nós e do mundo inteiro.</strong></li>
                <li> Pela compaixão da mulher que enxugou o seu rosto ensanguentado , <strong>tende misericórdia de nós e do mundo inteiro.</strong></li>
                <li> Pela sua 2ª queda, <strong>tende misericórdia de nós e do mundo inteiro.</strong></li>
                <li> Pelas palavras dirigidas as mulheres que dele se compadeciam, <strong>tende misericórdia de nós e do mundo inteiro.</strong></li>
                <li> Pela sua 3ª queda, <strong>tende misericórdia de nós e do mundo inteiro.</strong></li>
                <li> Pela dor que sentiu, quando o seu corpo foi despido, <strong>tende misericórdia de nós e do mundo inteiro.</strong></li>
                <li> Pela horrível perfuração dos pregos, que atravessaram suas mãos e os pés, <strong>tende misericórdia de nós e do mundo inteiro.</strong></li>
                <li> Pela água e o sangue emanados do seu coração, como fonte de todos os bens, <strong>tende misericórdia de nós e do mundo inteiro.</strong></li>
                <li> Pela lembrança de todos os tormentos de sua mãe quando o recebeu morto entre os braços, <strong>tende misericórdia de nós e do mundo inteiro.</strong></li>
                <li> Pela pedra que fechou o sepulcro, <strong>tende misericórdia de nós e do mundo inteiro.</strong></li>
                <li> Pela sua gloriosa ressurreição e aparição aos seus discípulos, comunicando-lhes a paz, <strong>tende misericórdia de nós e do mundo inteiro.</strong></li>
               
              </ul>
              <p><strong>Vós morrestes, Jesus mas uma fonte de vida jorrou para as almas, e abriu-se um mar de misericórdia Divina envolvei o mundo todo e derramai-vos sobre nós.</strong></p>
              <p><strong>A pedra fechou o sepulcro mas não para sempre. Renovemos diante dele a nossa fé na divindade de Cristo e na sua infinita misericórdia. Ela nos fará ressuscitar espiritualmente dos nossos pecados, como também nos conduzirá à completa ressurreição de todo o nosso ser na vida eterna. Amém</strong></p>
          ...
          <div class="w3-row">
            ...
            <div class="w3-col s12 w3-container">
              <h4 className="w3-center"><strong>Terço da Divina Misericórdia</strong></h4>
              <div class="w3-panel w3-yellow w3-topbar w3-bottombar w3-border-amber">
